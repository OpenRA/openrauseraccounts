...
$lang = array_merge($lang, array(
	...
	'ACP_BADGES_MANAGE'				=> 'Manage badges',
	'ACP_BADGES_MANAGE_EXPLAIN'			=> 'Using this form you can add, edit, and delete badges.',
	...
	'BADGE_TYPE_UPDATED'					=> 'The badge type was successfully updated.',
	'LOG_BADGE_TYPE_UPDATED'				=> '<strong>Updated badge type</strong><br>» %s',
	'BADGE_TYPE_ADDED'					=> 'The badge type was successfully added.',
	'LOG_BADGE_TYPE_ADDED'				=> '<strong>Added new badge type</strong><br>» %s',
	'BADGE_TYPE_USED'					=> 'Can not delete badge type. You have to remove associated badges first.',
	'LOG_BADGE_TYPE_DELETED'				=> '<strong>Removed badge type</strong><br>» %s',
	'BADGE_TYPE_DELETED'					=> 'The badge type was successfully deleted.',
	...
	'AVAIL_NOT_ADDED'				=> 'Could not add user to badge availability for "%s". The badge is already available for the user or the username could not be found.',
	'AVAIL_ADDED'					=> 'The "%s" badge is now available for users "%s".<br>',
	...
	'ALL_AVAILS_DELETED'					=> 'All users have been removed from the badge availability',
	'SELECTED_AVAILS_DELETED'	=> 'The selected users have been removed from the badge availability.',
	'REMOVE_ALL'				=> 'Remove all',
	'REMOVE_MARKED'				=> 'Remove marked',
	'NO_AVAILS'					=> 'Badge is not available for any users.',
	'USERNAME'					=> 'Username',
));
